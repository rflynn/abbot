...
en_eb([], Wr) -> util:j(Wr);
% phrases
en_eb(["i","agree"                   | Rd], Wr) -> en_eb(Rd, Wr ++ ["word"]);
en_eb(["i","concur"                  | Rd], Wr) -> en_eb(Rd, Wr ++ ["word"]);
en_eb(["i","would","really","like"   | Rd], Wr) -> en_eb(Rd, Wr ++ ["nigga wanna"]);
en_eb(["i","would","like"            | Rd], Wr) -> en_eb(Rd, Wr ++ ["nigga wanna"]);
en_eb(["i","really","want"           | Rd], Wr) -> en_eb(Rd, Wr ++ ["nigga wanna"]);
...
en_eb(["i","love","you"              | Rd], Wr) -> en_eb(Rd, Wr ++ ["much love"]);
en_eb(["hit","on"     | Rd], Wr) -> en_eb(Rd, Wr ++ ["mac"]);
en_eb(["right","now"  | Rd], Wr) -> en_eb(Rd, Wr ++ ["up in here"]);
en_eb(["get","high"   | Rd], Wr) -> en_eb(Rd, Wr ++ ["be mad blazin"]);
...
en_eb(["i","need","to"| Rd], Wr) -> en_eb(Rd, Wr ++ ["gotta"]);
...
en_eb(["my","enemies" | Rd], Wr) -> en_eb(Rd, Wr ++ ["those motherfuckers"]);
% single words
en_eb(["mother"       | Rd], Wr) -> en_eb(Rd, Wr ++ ["momma"]);
en_eb(["better"       | Rd], Wr) -> en_eb(Rd, Wr ++ ["betta"]);
en_eb(["aren't"       | Rd], Wr) -> en_eb(Rd, Wr ++ ["ain't"]);
en_eb(["doing"        | Rd], Wr) -> en_eb(Rd, Wr ++ ["be"]);
en_eb(["walk"         | Rd], Wr) -> en_eb(Rd, Wr ++ ["stroll"]);
en_eb(["see"          | Rd], Wr) -> en_eb(Rd, Wr ++ ["peep"]);
en_eb(["look","at"    | Rd], Wr) -> en_eb(Rd, Wr ++ ["peep"]);
en_eb(["look"         | Rd], Wr) -> en_eb(Rd, Wr ++ ["peep"]);
...
en_eb(["that"         | Rd], Wr) -> en_eb(Rd, Wr ++ ["dat"]);
en_eb(["drive"        | Rd], Wr) -> en_eb(Rd, Wr ++ ["roll"]);
en_eb(["hello"        | Rd], Wr) -> en_eb(Rd, Wr ++ ["wassup"]);
en_eb(["greetings"    | Rd], Wr) -> en_eb(Rd, Wr ++ ["wassup"]);
en_eb(["goodbye"      | Rd], Wr) -> en_eb(Rd, Wr ++ ["laterz"]);
en_eb(["good","bye"   | Rd], Wr) -> en_eb(Rd, Wr ++ ["laterz"]);
en_eb(["goodnight"    | Rd], Wr) -> en_eb(Rd, Wr ++ ["peace out"]);
...
en_eb(["excellent"    | Rd], Wr) -> en_eb(Rd, Wr ++ ["bomb"]);
en_eb(["smoking"      | Rd], Wr) -> en_eb(Rd, Wr ++ ["puff"]);
...
en_eb(["any"         | Rd], Wr) -> en_eb(Rd, Wr ++ ["mad"]);
...
en_eb(["promiscuous"  | Rd], Wr) -> en_eb(Rd, Wr ++ ["chickenhead"]);
...
en_eb(["relax"        | Rd], Wr) -> en_eb(Rd, Wr ++ ["chill"]);
...
en_eb(["crazy"        | Rd], Wr) -> en_eb(Rd, Wr ++ ["whack"]);
...
en_eb(["unusual"      | Rd], Wr) -> en_eb(Rd, Wr ++ ["whack"]);
en_eb(["strange"      | Rd], Wr) -> en_eb(Rd, Wr ++ ["whack"]);
en_eb(["strangely"    | Rd], Wr) -> en_eb(Rd, Wr ++ ["whack"]);
en_eb(["sluts"        | Rd], Wr) -> en_eb(Rd, Wr ++ ["chickenheads"]);
...
en_eb(["are"          | Rd], Wr) -> en_eb(Rd, Wr ++ ["be"]);
en_eb(["these"        | Rd], Wr) -> en_eb(Rd, Wr ++ ["deez"]);
% ignore words
